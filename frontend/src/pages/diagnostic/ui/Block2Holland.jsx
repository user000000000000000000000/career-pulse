...
export default function Block2Holland() {
  ...
  async function submit() {
    ...
    await CP.saveBlockResult(2, { answers: pairAnswers, scores: { ...rest, flags }, durationSec: dur, openAnswers: [{ questionId: 'open', text: openText }] })
    await CP.updateProfile({
      holland_scores: { R: rest.R, I: rest.I, A: rest.A, S: rest.S, E: rest.E, C: rest.C },
      holland_top2: rest.holland_top2, holland_code: rest.holland_code, career_archetype: rest.career_archetype,
      profile_clarity: rest.profile_clarity, profile_flexibility: rest.profile_flexibility,
      interest_maturity: rest.interest_maturity, anti_interests: rest.anti_interests,
      energy_sources: rest.energy_sources, exploration_index: rest.exploration_index,
    })
    if (flags.length) await CP.updateExpertData({ flags })
    clearDraft()
    setResult({ ...rest, durationSec: dur })
  }
