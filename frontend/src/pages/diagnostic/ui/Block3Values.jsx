...
export default function Block3Values() {
  ...
  async function submit() {
    ...
    await CP.updateProfile({
      values_top3: rest.values_top3, values_antitop2: rest.values_antitop2, anti_values_chosen: rest.anti_values_chosen,
      motivation_type: rest.motivation_type, values_archetype: rest.values_archetype,
      values_consistency: rest.values_consistency, values_scale_type: rest.values_scale_type,
    })
  ...
  if (result) {
    const motMap = { meaning: 'Смысловой', result: 'Результативный', mixed: 'Смешанный' }
    return (
