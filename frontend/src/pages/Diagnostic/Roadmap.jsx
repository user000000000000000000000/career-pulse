...
export default function Roadmap() {
  ...
  if (roadmap) {
    return <Shell>
      ...
      {roadmap.intro && (
        <div className="r-card" style={{ borderColor: 'rgba(123,92,240,.3)', background: 'linear-gradient(135deg, rgba(123,92,240,.08), rgba(0,229,200,.04))', marginBottom: 20 }}>
          <div className="r-label" style={{ color: '#a480f8', marginBottom: 8 }}>🤖 От наставника</div>
