...
export default function Block1Anketa() {
  ...
  async function submit() {
    ...
    const context = { name: ans.A1, age: ans.A2, grade: ans.A3, city: ans.A4, gender: ans.A5, education_format: ans.A6, plans_after_school: ans.V1, ege_subjects: ans.B1, favorite_subjects: ans.B2, subject_motivation: ans.B2a, disliked_subjects: ans.B3, avg_grade: ans.B4, relocation_ready: ans.V2, budget: ans.V3, main_concern: ans.G3, decision_maker: ans.G4 }
